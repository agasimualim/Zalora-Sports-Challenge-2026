...
const CONFIG = {
  ...
  // --- Teams ---
  TEAMS: [
    { id: 1, name: 'Indonesia',  color: '#FF6B6B', emoji: '🔴' },
    { id: 2, name: 'Malaysia',  color: '#4ECDC4', emoji: '🟢' },
    { id: 3, name: 'Philippines',  color: '#FFE66D', emoji: '🟡' },
    { id: 4, name: 'Singapore',  color: '#A78BFA', emoji: '🟣' },
    { id: 5, name: 'Vietnam',  color: '#F97316', emoji: '🟠' },
  ],
